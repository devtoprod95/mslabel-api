...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('main_intro2_datas', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement('ALTER TABLE main_intro2_datas COMMENT "메인 소개2 리스트"');
    }
    ...
    {
        Schema::dropIfExists('main_intro2_datas');
    }
};