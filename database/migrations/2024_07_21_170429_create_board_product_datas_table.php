...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('board_product_datas', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement('ALTER TABLE board_product_datas COMMENT "상품 유형 게시판 테이블"');
    }
    ...
    {
        Schema::dropIfExists('board_product_datas');
    }
};